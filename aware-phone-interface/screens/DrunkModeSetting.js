...
const DrunkModeScreen = ({ navigation }) => {
  const [drunkMode, setDrunkMode] = React.useState(false);
  ...
  const drunkOptions = [
    { label: 'App restricitons', icon: 'apps' },
    ...
    <ScrollView style={styles.container}>
      ...
      <List.Item
        ...
        right={() => (
          <Switch
            value={drunkMode}
            onValueChange={() => setDrunkMode(!drunkMode)}
          />
        )}
      />
      ...
      <List.Item
        ...
        <Text style={styles.extrainfo}>Allow tracking to monitor your movements and interactions while in Drunk Mode, helping to ensure your safety and providing insights about your behavior</Text>
    </ScrollView>
  );
};
